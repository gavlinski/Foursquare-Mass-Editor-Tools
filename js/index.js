...
dojo.addOnLoad(function() {
  ...
  dojo.connect(form_csv, "onSubmit", function(e) {
    ...
    dojo.cookie("pagina", "", { expires: 10 });
    dojo.cookie("textarea", "", { expires: 10 });
    dojo.cookie("accordion", dijit.byId("accordion").selectedChildWidget.id, { expires: 10 });
  });
  ...
  dojo.connect(form_txt, "onSubmit", function(e) {
    ...
    dojo.cookie("pagina", "", { expires: 10 });
    dojo.cookie("textarea", "", { expires: 10 });
    dojo.cookie("campos", dijit.byId("nome1").checked + "." + dijit.byId("endereco1").checked + "." + dijit.byId("ruacross1").checked + "." + dijit.byId("cidade1").checked + "." + dijit.byId("estado1").checked + "." + dijit.byId("cep1").checked + "." + dijit.byId("twitter1").checked + "." + dijit.byId("telefone1").checked + "." + dijit.byId("website1").checked + "." + dijit.byId("descricao1").checked + "." + dijit.byId("latlong1").checked, { expires: 10 });
    dojo.cookie("accordion", dijit.byId("accordion").selectedChildWidget.id, { expires: 10 });
  });
...
function showDialog_txt() {
  // set the content of the dialog:
  dlg_txt.attr("content", "Um arquivo de texto &eacute; uma esp&eacute;cie de arquivo simples estruturado como uma sequ&ecirc;ncia de linhas. O arquivo deve conter os identificadores de cada venue a ser editada.</p><p>Os principais tipos reconhecidos s&atilde;o os seguintes:<ul><li><b>IDs ou URLs das venues:</b> arquivo TXT com os IDs ou URLs das venues</li><li><span style='text-decoration: line-through;'><b>Resultado da pesquisa do Places:</b> arquivo HTML salvo a partir do <a href='https://foursquare.com/admin/places'>Places</a></span></li><li><b>Resultado da pesquisa do Tidysquare:</b> arquivo HTML salvo a partir do <a href='http://www.tidysquare.com'>Tidysquare</a></li></ul><p><b>Exemplo de arquivo TXT:</b></p><p style='font-family: courier, monospace;'>https://foursquare.com/venue/banco-do-brasil/4c701c87f23c76b0c5abe685<br>https://pt.foursquare.com/v/banco-do-brasil/4d7a895be8b7a1cdb4e3991f/<br>https://foursquare.com/v/4eadbb7902d5cf33fa8cf19e/edit<br>4e764d9888775d593e595c62</p>");
  dlg_txt.show();
}
