	...
	setTimeout(function() {
		...
		if (dojo.cookie("campos") != undefined) {
			...
			for (i = 1; i < 5; i++) {
				...
				(dijit.byId("instagram" + i).disabled) ? dijit.byId("instagram" + i).attr("checked", false) : dijit.byId("descricao" + i).attr("checked", (campos[12] === 'true'));
				...
				(dijit.byId("menu" + i).disabled) ? dijit.byId("menu" + i).attr("checked", false) : dijit.byId("descricao" + i).attr("checked", (campos[15] === 'true'));
				(dijit.byId("horas" + i).disabled) ? dijit.byId("horas" + i).attr("checked", false) : dijit.byId("descricao" + i).attr("checked", (campos[16] === 'true'));
			}
