...
'. TEMPLATE2);
define("ERRO02", LINKS . DOJO_INIT . HBODY . TEMPLATE1 . '<p>Erro na leitura do cabe&ccedil;alho ou conjunto de caracteres inv&aacute;lido.</p>
